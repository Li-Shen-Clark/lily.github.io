...
*Flagship project: trade-cost shocks, domestic production networks, and local export multipliers.*
*with Kensuke Suzuki, Xiaocong Xu, and Junfu Zhang*

**[Abstract]({{ '/files/JMP_Abstract.pdf' | relative_url }})**
...
- Establishes that local trade multipliers are equilibrium objects shaped by the structure of domestic production linkages rather than universal parameters, and identifies the **own-trade share (home share)**---not raw export exposure---as the structural organizing statistic for multiplier heterogeneity.
...
*Second dissertation paper: transport connectivity, passenger mobility, and spatial price dispersion.*
